...
class ColoresDegradado {
  final List<Color> colors;
  ColoresDegradado(this.colors);
...
class DegradadoTemplate {
  static List<ColoresDegradado> gradientTemplate = [
    ColoresDegradado(ColoresDegradado.sky),
    ColoresDegradado(ColoresDegradado.sunset),
    ColoresDegradado(ColoresDegradado.sea),
    ColoresDegradado(ColoresDegradado.mango),
    ColoresDegradado(ColoresDegradado.fire),
  ];
}
